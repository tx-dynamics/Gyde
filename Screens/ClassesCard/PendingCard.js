...
export default function PendingCard(props) {
    return (
        ...
        <View style={[styles.boxWithShadow, {
            ...
            <View style={{ flexDirection: "row", justifyContent: "space-between", paddingHorizontal: wp(10), paddingBottom: wp(5), marginTop: 10 }}>
                <Image source={iconPath.messageIcon} style={{ width: wp(7), height: wp(7), resizeMode: "contain" }} />
                <Image source={iconPath.CallIcon} style={{ width: wp(7), height: wp(7), resizeMode: "contain" }} />
                <Image source={iconPath.attachmentIcon} style={{ width: wp(7), height: wp(7), resizeMode: "contain" }} />
            </View>
        </View>
    )
}
